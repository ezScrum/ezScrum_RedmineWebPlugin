...
Plugin.TaskBoard.projectLeftTree.TreePlugin = Ext.extend(Object, {
	...
	onRender: function() {
		var childNode = {
			id:'redmineCofig',
			text : '<u>Redmine Config</u>',
			cls:'treepanel-leaf',
        	iconCls:'leaf-icon',
			leaf:true,
			listeners: {
				click: function(node, event) {
					var index = Ext.getCmp('content_panel').items.keys.indexOf("redmineCofigPage");
...
Ext.preg('redmine_TreeNode', Plugin.TaskBoard.projectLeftTree.TreePlugin);
